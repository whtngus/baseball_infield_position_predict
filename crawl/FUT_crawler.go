...
//    res, err := http.Get(url)
	...
	for i := 0 ; i < 100000 ; i++ {
	    res, err := http.Get("https://www.koreabaseball.com/Futures/Player/HitterDetail.aspx?playerId="+strconv.Itoa(i))
	    if err != nil {
	        log.Fatal(err)
	    }
...
func main() {
    ...
    log.Fatal(http.ListenAndServe(":8789", nil))
}
